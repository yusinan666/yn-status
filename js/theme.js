// =========================================================
//  GTA:Yonder — Theme Manager
// =========================================================

const STORAGE_KEY = 'gta-yonder-theme'
...
export function applyTheme(theme) {
  ...
  if (meta) meta.setAttribute('content', resolved === 'dark' ? '#070B0A' : '#F5F7F6')
}
...
export const themeIcons = {
  ...
  dark: '<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M21 12.79A9 9 0 1111.21 3 7 7 0 0021 12.79z"/></svg>',
